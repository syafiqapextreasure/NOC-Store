...
import 'package:nocstore/model/BlockUserModel.dart';
import 'package:nocstore/model/BrandsModel.dart';
import 'package:nocstore/model/ChatVideoContainer.dart';
...
import 'package:nocstore/model/Ratingmodel.dart';
import 'package:nocstore/model/ReviewAttributeModel.dart';
...
import 'package:nocstore/model/conversation_model.dart';
import 'package:nocstore/model/email_template_model.dart';
import 'package:nocstore/model/inbox_model.dart';
import 'package:nocstore/model/notification_model.dart';
import 'package:nocstore/model/referral_model.dart';
import 'package:nocstore/model/story_model.dart';
import 'package:nocstore/model/topupTranHistory.dart';
import 'package:nocstore/model/withdrawHistoryModel.dart';
import 'package:nocstore/services/helper.dart';
import 'package:nocstore/ui/DineIn/BookTableModel.dart';
import 'package:nocstore/ui/offer/offer_model/offer_model.dart';
import 'package:nocstore/ui/reauthScreen/reauth_user_screen.dart';
...
class FireStoreUtils {
  ...
  Future<String> uploadImageOfStory(File image, BuildContext context, String extansion) async {
    updateProgress('Uploading thumbnail...'.tr());
    ...
    uploadTask.snapshotEvents.listen((event) {
      updateProgress('${"Uploading image ".tr()}${(event.bytesTransferred.toDouble() / 1000).toStringAsFixed(2)} /'
  ...
  Future<String?> uploadVideoStory(File video, BuildContext context) async {
    ...
    uploadTask.snapshotEvents.listen((event) {
      updateProgress('${"Uploading video ".tr()}${(event.bytesTransferred.toDouble() / 1000).toStringAsFixed(2)} /'
          '${(event.totalBytes.toDouble() / 1000).toStringAsFixed(2)} '
          'KB'.tr());
    });
    var storageRef = (await uploadTask.whenComplete(() {})).ref;
  ...
  Future<Url> uploadAudioFile(File file, BuildContext context) async {
    ...
    uploadTask.snapshotEvents.listen((event) {
      updateProgress('${"Uploading Audio ".tr()}${(event.bytesTransferred.toDouble() / 1000).toStringAsFixed(2)} /'
          '${(event.totalBytes.toDouble() / 1000).toStringAsFixed(2)} '
          'KB'.tr());
    });
    uploadTask.whenComplete(() {}).catchError((onError) {
