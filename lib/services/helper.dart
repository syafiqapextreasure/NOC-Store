...
showProgress(BuildContext context, String message, bool isDismissible) async {
  ...
  progressDialog.style(
      ...
      messageTextStyle: TextStyle(fontFamily: "Poppinsb",color: Colors.black, fontSize: 19.0, fontWeight: FontWeight.w600));
                ...
                Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Visibility(
                        visible: withdrawHistoryModel.note != null && withdrawHistoryModel.note.isNotEmpty && withdrawHistoryModel.adminNote != null && withdrawHistoryModel.adminNote.isNotEmpty,
                        child: Padding(
                          padding: const EdgeInsets.all(10.0),
                          child: Divider(
                            thickness: 2,
