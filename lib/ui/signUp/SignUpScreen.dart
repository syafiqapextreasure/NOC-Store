...
import 'package:nocstore/ui/phoneAuth/PhoneNumberInputScreen.dart';
      ...
      children: <Widget>[
        new Align(
            ...
            child: Text(
              ...
              style: TextStyle(color: Color(0xFFFEDF00), fontWeight: FontWeight.bold, fontSize: 25.0),
            ).tr()),
        Padding(
        ...
        InkWell(
          ...
          child: /*Text(
            ...
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), border: Border.all(color: Color(0xFFFEDF00), width: 1)),
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    'Sign up with phone number'.tr(),
                    style: TextStyle(color: isDarkMode(context) ? Color(COLOR_PRIMARY) : Colors.black, fontWeight: FontWeight.bold, fontSize: 15, letterSpacing: 1),
                  ),
                ],
              ),
            ),
  ...
  _signUpWithEmailAndPassword() async {
    if (_key.currentState?.validate() ?? false) {
      ...
      if(mobile != null) {
        ...
        dynamic result = await FireStoreUtils
        ...
        if (result != null && result is User) {
          if (auto_approve_vendor == true) {
            ...
            if (result.vendorID.isNotEmpty) {
              await FireStoreUtils.firestore.collection(VENDORS).doc(
                  result.vendorID).update({"fcmToken": result.fcmToken});
            }
          ...
          showAlertDialog(
              context, 'Failed'.tr(), "Couldn't sign up".tr(), true);
        }
      }else{
