...
import 'package:nocstore/ui/resetPasswordScreen/ResetPasswordScreen.dart';
        ...
        child: ListView(
          children: <Widget>[
            Padding(
              ...
              child: Text(
                'Log In'.tr(),
                style: TextStyle(color: Color(0xFFFEDF00), fontSize: 25.0, fontWeight: FontWeight.bold),
              ),
            ),
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration:
                    BoxDecoration(borderRadius: BorderRadius.circular(30), border: Border.all(color: Color(0xFFFEDF00), width: 1)),
                child: Padding(
