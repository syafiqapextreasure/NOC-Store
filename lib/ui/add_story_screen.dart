...
import 'package:nocstore/video_widget.dart';
                      ...
                      onPressed: () async {
                        if (thumbnailFile == null) {
                          ...
                          if (thumbnailFile is File) {
                            url =
                                await FireStoreUtils().uploadImageOfStory(thumbnailFile!, context, getFileExtension(thumbnailFile!.path)!);
                          } else {
                            url = thumbnailFile;
                          }
                          ...
                          StoryModel? storyModel = StoryModel(
                              ...
                              sectionID: MyAppState.currentUser!.section_id,
      ...
      child: Container(
        ...
        child: Card(
          ...
          child: thumbnailFile == null
              ...
              : ClipRRect(
                  borderRadius: BorderRadius.circular(12),
                  child: thumbnailFile is File
                      ? Image.file(thumbnailFile!, fit: BoxFit.fill)
                      : Image.network(thumbnailFile!, fit: BoxFit.fill),
                ),
        ),
      ),
    );
