  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          PageView.builder(
            itemBuilder: (context, index) => getPage(isDarkMode(context) ? _darkimageList[index] : _imageList[index], _titlesList[index], _subtitlesList[index],
                context, isDarkMode(context) ? (index + 1) == _darkimageList.length : (index + 1) == _imageList.length),
                  ...
                  child: Container(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)), backgroundColor: Color(COLOR_PRIMARY)),
                        child: Text(
                          "GET STARTED".tr(),
            ...
            child: Align(
              ...
              child: SmoothPageIndicator(
                ...
                effect: ScrollingDotsEffect(
                    spacing: 20, activeDotColor: Color(COLOR_PRIMARY), dotColor: Color(0XFFFBDBD1), dotWidth: 7, dotHeight: 7, fixedCenter: false),
              ),
            ),
          )),
          Visibility(
      ...
      children: <Widget>[
        ...
        Padding(
            ...
            child: Text(
              ...
              textAlign: TextAlign.center,
              style: TextStyle(
                  color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(0XFF333333), fontFamily: 'Poppinsl', height: 2, letterSpacing: 1.2, fontSize: 15),
            )),
