...
class _OffersScreenState extends State<OffersScreen> {
  ...
  void initState() {
    ...
    if (MyAppState.currentUser!.vendorID.isEmpty) {
      ...
      lstOfferData =
          fireStoreUtils.getOfferStream(MyAppState.currentUser!.vendorID);
    }
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          ...
                                          snapshot.data![index].discountType == "Fix Price" ? (currencyData!.symbolatright == true) ? "${snapshot.data![index].discount}${currencyData!.symbol.toString()} OFF":"${currencyData!.symbol.toString()}${snapshot.data![index].discount} OFF"
