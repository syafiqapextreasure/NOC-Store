...
class _AddOfferScreenState extends State<AddOfferScreen> {
  ...
  void initState() {
    ...
    if (widget.offerModel != null) {
      ...
      txtExpieryDate.text =
          getDate(widget.offerModel!.expiresAt!.toDate().toString())!;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                focusedBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                      color: Color(0xFFFEDF00), width: 1.0),
                                )),
                          ),
                          SizedBox(
                            height: 30,
                          ...
                          TextFormField(
                            ...
                            validator: validateEmptyField,
                            decoration: InputDecoration(
                                hintText: _result == "Percentage".tr()
                                    ? "Add percentage".tr()
                                    : "Add price".tr(),
                                suffixIcon: Container(
                                  margin: EdgeInsets.only(top: 11, right: 0),
                                  child: Text(
                                    _result == "Percentage".tr()
                                        ? "%"
                                        : currencyData!.symbol,
                                    style: TextStyle(
                          ...
                          DateTimeField(
                            ...
                            validator: (date) => (txtExpieryDate.text == '')
                            ...
                            onShowPicker: (context, currentValue) {
                              return showDatePicker(
                                  ...
                                  initialDate: widget.offerModel == null
                                      ? DateTime.now()
                                      : widget.offerModel!.expiresAt!.toDate(),
                          ...
                          _mediaFiles.isEmpty == true
                              ? InkWell(
                                  ...
                                  child: widget.offerModel == null
                                      ? Image(
                                          image: AssetImage(
                                              "assets/images/add_offer_img.png"),
                ...
                onTap: () async {
                  if (_formKey.currentState?.validate() == false) {
                    ...
                    if (_mediaFiles.length > 0) {
                      ...
                      Reference upload =
                          FirebaseStorage.instance.ref().child(STORAGE_ROOT +
                      ...
                      var storageRef =
                          (await uploadTask.whenComplete(() {})).ref;
