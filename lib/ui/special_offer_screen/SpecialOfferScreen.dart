...
import 'package:nocstore/model/SpecialDiscountModel.dart';
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Icon(Icons.add_circle_sharp, color: Color(0xFFFEDF00), size: 36),
                            )
                          ],
                        ),
                        ListView.builder(
  ...
  saveSpecialOffer() async {
    ...
    if (vendorModel != null) {
      ...
      await FireStoreUtils.updateVendor(vendorModel!).then((value) async {
        await showProgress(context, 'Update Special discount...'.tr(), false);
        await hideProgress();
      });
    }
  }
